...
> Source: https://partner.tiktokshop.com/docv2/page/common-errors
> Section: Developer Guide
> Scraped: 2026-05-21T00:23:42.526Z
...
Please wait and try again. Refer to [Rate limits](rate-limits) for details.
...
For `category_asset_cipher`, ensure you retrieve the correct value from the [Get Authorized Category Assets](get-authorized-category-assets) endpoint.  
...
Refer to the [authorization guide](authorization-overview-202407) for details.
...
2\. Check the granted scopes for the token in the `granted_scopes` field of the [Get Access Token](<authorization-overview-202407#Get Access Token API>) response. If the required scope is missing, request the user to reauthorize the required scope, and then generate a new token accordingly.
...
Refresh your token by using the [Get Refresh Token](<authorization-overview-202407#Get Refresh Token API>) endpoint.
...
Ensure you generate a valid signature by referring to the [guide on signing your request](sign-your-api-request).
...
Generate a signature by referring to the [guide on signing your request](sign-your-api-request).
...
Please pass in the `access_token` you obtained from the [Get Access Token](<authorization-overview-202407#Get Access Token API>)endpoint.
...
Retrieve this value from the [Get Authorized Shops](get-authorized-shops) endpoint.
...
Retrieve the correct value from the [Get Authorized Shops](get-authorized-shops) endpoint.
...
The `auth_code` has already been used, is expired, or is invalid.
