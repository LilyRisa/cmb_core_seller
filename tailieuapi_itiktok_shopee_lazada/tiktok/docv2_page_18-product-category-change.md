...
> Section: Webhooks
> Scraped: 2026-05-21T00:29:54.621Z
...
ID of the product promoted in the creator's video.

 |
| 

└previous\_category\_id
...
The category ID of the product before the category update.

 |
| 

└current\_category\_id
...
The category ID of the product after the category update.
...
The time when this category update happens, represented by Unix timestamp.
