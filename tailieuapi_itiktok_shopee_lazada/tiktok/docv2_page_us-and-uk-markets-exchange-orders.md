...
> Section: Changelog
> Scraped: 2026-05-21T00:37:23.558Z
...
\* `is_exchange_order`: Indicates an exchange order when **TRUE**.  
\* `exchange_order_source_id`: If `is_exchange_order=TRUE`, returns the ID of the original order.
