...
> Section: Changelog
> Scraped: 2026-05-21T00:44:48.617Z
...
1.  Developers should integrate with the `audit.status` and `audit.pre_approved_reasons` parameters, as well as the new product audit status change webhook, to display the correct statuses on their app's interface.
