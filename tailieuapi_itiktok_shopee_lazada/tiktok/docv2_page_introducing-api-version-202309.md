...
> Section: Changelog
> Scraped: 2026-05-21T00:49:00.380Z
...
Local and cross-border sellers in all markets
...
[Get Product List](get-order-list)
...
Will be available on the following dates for different markets:  
  
\* Available for local and cross-border sellers in the UK market on Sept 21.  
\* Available for local sellers in the US market on Sept 27.  
\* Available for ID, PH, MY, VN, SG, TH markets on Oct 9.  
...
Only available for local sellers in the US market
...
As of now, the API endpoint is only available for local sellers in the US market  
  
Will be available for local sellers in the UK market before October 30, 2023
...
The API endpoint is available for local and cross-border sellers in all markets  
  
As of now, item level cancellation is only available for local and cross-border sellers in the US market.
...
Local sellers in the US and UK markets
...
[Get Withdrawals](get-statements)
...
Local and cross-border sellers in the SG, PH, MY, TH, VN markets.  
Local sellers in the ID markets
...
-   Use [Mapping APIs from legacy to v202309](<upgrading-to-api-version-202309#Mapping APIs from legacy to v202309>) to find out what new endpoints to replace with the current legacy API endpoints you are using
