# For the TH market: Updates to mandatory certifications for certain product categories

> Source: https://partner.tiktokshop.com/docv2/page/for-th-market-updates-to-mandatory-certifications-for-certain-product-categories
> Section: Changelog
> Scraped: 2026-05-21T00:41:22.402Z
...
| --- | --- |
| 
Tools & Hardware > Hand Tools > Industrial Scales

 | 

Important Document Showing Certification of Weights and Measures

 |
| 

Kitchenware > Kitchen Utensils & Gadgets > Kitchen Scales

 | 

Image of product with 'Do not use the scale for trading' mark

 |
| 

For multiple categories of Household Appliances

 | 

TIS Certificate Mark on Product Label
