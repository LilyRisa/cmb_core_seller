...
> Scraped: 2026-05-20T23:24:29.202Z
...
DESCRIPTION\_CHARACTERS\_LESS\_THAN\_80\_CHARS
...
MAIN\_IMG\_FIRST\_IMG\_LOW\_QUALITY
...
MAIN\_IMG\_FIRST\_IMG\_MISSING\_PRODUCT\_SUBSTANCE  
...
MAIN\_IMG\_FIRST\_IMG\_PRODUCT\_SUBJECT\_NOT\_COMPLETE
...
MAIN\_IMG\_FIRST\_IMG\_TEXT\_OVERLOAD
...
MAIN\_IMG\_FIRSTIMG\_LOW\_QUALITY\_BACKGROUND
...
MAIN\_IMG\_FIRSTIMG\_WATERMARK
...
**(New)** MAIN\_IMG\_FIRST\_IMG\_SPLICED\_PICTURE

 | 

First image: Use full, standalone product images instead of collages.
...
**(Retired)** MAIN\_IMG\_SPLICED\_PICTURE
...
**(New)** MAIN\_IMG\_PROMOTION\_IMAGE  

 | 

Use an image that does not contain any marketing or promotion stickers, such as "free shipping" or "best sale".
...
TITLE\_NOT\_INCLUDE\_PRODUCT\_SUBJECT\_WORDS
...
TITLE\_NOT\_INCLUDE\_VARIETY\_WORDS
...
**(Retired)** ATTRIBUTE\_MISSING\_SHOPPING\_GUIDE\_ITEM
...
DESCRIPTION\_HAVE\_TOO\_LONG\_PARAGRAPH
...
DESCRIPTION\_INCLUDE\_INVALID\_IMAGE
...
DESCRIPTION\_INCLUDE\_LESS\_THAN\_3\_IMAGES
...
DESCRIPTION\_NOT\_PROPER\_CAPITALIZATION
...
PRD\_NOT\_INCLUDE\_APPLICABLE\_SCOPE
...
PRD\_NOT\_INCLUDE\_FRAGRANCE\_NOTES
...
PRD\_NOT\_INCLUDE\_INGREDIENTS
...
PRD\_NOT\_INCLUDE\_INGREDIENTS\_LIST
...
**(Retired)** PRD\_NOT\_INCLUDE\_KEY\_PARAMETER\_LIST
...
PRD\_NOT\_INCLUDE\_MATERIAL\_DETAILS
...
PRD\_NOT\_INCLUDE\_NUTRITION\_FACT
...
**(Retired)** PRD\_NOT\_INCLUDE\_PACKAGE\_LIST
...
PRD\_NOT\_INCLUDE\_PRD\_BENEFITS
...
PRD\_NOT\_INCLUDE\_SPECIFICATIONS
...
PRD\_NOT\_INCLUDE\_MULTI\_ANGLE\_OR\_DETAIL\_DISPLAY

 | 

Add multi-angle or detailed images to fully display the products
...
MAIN\_IMG\_FIRST\_IMG\_BACKGROUND\_UNTIDY
...
MAIN\_IMG\_FIRST\_IMG\_BLACK\_BORDER
...
MAIN\_IMG\_FIRST\_IMG\_FAKE\_MODEL
...
MAIN\_IMG\_FIRST\_IMG\_NOT\_CLEAR
...
MAIN\_IMG\_FIRST\_IMG\_WHITE\_BORDER
...
MAIN\_IMG\_LESS\_THAN\_5\_IMAGES
...
MAIN\_IMAGE\_COUNT\_NOT\_MEET\_STANDARD

 | 

Please upload more main images to ensure better product display. The required number of images varies by category(e.g., at least 1, 3, 4, or 5 images). Refer to the suggestions in the diagnostic results for details.
...
**(Retired)** SIZE\_CHART\_NOT\_INCLUDE\_STANDARDIZED\_SIZE\_INFO

 | 

Provide a complete size chart with all relevant measurements.  
...
**(New)** SIZE\_CHART\_NOT\_INCLUDE\_SIZE\_INFO  

 | 

Provide at least 1 size variation (such as S, M, or L) and 1 size dimension (such as bust, waist, or hip)
...
**(Retired)** TITLE\_LESS\_THAN\_25\_CHARS
...
| **Category**  
 | **Region**  
 | **Diagnosis result (`diagnosis_results.code`）** | **Recommendations** |
| --- | --- | --- | --- |
| 
Description
...
DESC\_LESS\_THAN\_FIVE\_HUNDRED\_CHARS
...
**(New)** DESC\_LESS\_THAN\_FIFTY\_CHARS

 | 

Extend the product description to at least 50 characters.
...
MAIN\_IMG\_FIRST\_IMG\_INCLUDE\_NON\_LOCAL\_LANGUAGE
...
MAIN\_IMG\_FIRST\_IMG\_SPLICED\_PICTURE
...
MAIN\_IMG\_NUMBER\_LESS\_THAN\_FIVE
...
TITLE\_LESS\_THAN\_40\_CHARACTERS
...
**(New)** TITLE\_LESS\_THAN\_25\_CHARACTERS

 | 

Extend the title to at least 25 characters.
