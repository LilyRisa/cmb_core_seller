...
> Source: https://partner.tiktokshop.com/docv2/page/get-widget-token
> Section: Developer Guide
> Scraped: 2026-05-21T00:26:27.983Z
...
\* /authorization/202401/widget\_token
...
This api is used to get your widget token to pass widget api.
...
5361235029d141222525e303d742f9e38aea052d10896d3197ab9d6233730b8c

 | 

\> Notes: Try to be descriptive  
  
[Signature generated by gen algorithm](https://partner.tiktokshop.com/us/doc/page/274638). When you send API requests to TTS, you must sign them so that TTS can identify the senders.
...
aaaaa000-aaa0-aaa0-aaa0-aaaaaaaaa000

 | 

[Authorization Token,](https://partner.tiktokshop.com/us/doc/page/261250) provided for all eligible TikTok Shop Partner Developers. Set it in header
...
The [API interface version](https://partner.tiktokshop.com/us/doc/page/275907) you want to access
...
> For Example: order\_status is a key component. Link back to "Business Guide" if possible  
...
widget token related info struct
...
The expire timestamp of widget token. Usually expire in 5 minutes
...
Unable to retrieve authorized shop info.. The SLA will be affected.

 | 

System error. If it occur frequently, please oncall.
...
This case happened when you use a wrong token to access this api
