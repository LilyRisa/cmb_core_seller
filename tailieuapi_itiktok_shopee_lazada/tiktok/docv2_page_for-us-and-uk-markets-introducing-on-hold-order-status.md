...
> Section: Changelog
> Scraped: 2026-05-21T00:35:28.241Z
...
We strongly recommend updating to API v202309. "On Hold" status is at the store level. If a seller installs more than one application and if ANY ONE of the apps are not updated, you will not get the "On Hold" status. Refer to \[Required Actions\](#Required Actions) section for details on how to support the new status. Learn more about how to upgrade to the v202309 version here: [Upgrading to API version 202309](https://partner.tiktokshop.com/docv2/page/upgrading-to-api-version-202309).
...
Create a new Sandbox 2.0 shop and a new draft app (with new app\_key), then authorize the app to the shop.  
