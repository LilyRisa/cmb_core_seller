...
> Section: Changelog
> Scraped: 2026-05-21T00:50:51.239Z
...
A new input parameter `INVOICE_LABEL`. For Brazil market only, document\_size is fixed to A6, and you don't need to specify document\_size.
...
The second line of the warehouse address, like flat, apartment, or suite. **Note:** For Brazilian market, this represents the street name.
...
This represents supplementary information, like flat, apartment, or suite (optional). **Note:** Available only in Brazilian market.
