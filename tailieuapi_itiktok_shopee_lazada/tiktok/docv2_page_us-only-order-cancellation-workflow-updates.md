...
> Section: Changelog
> Scraped: 2026-05-21T00:38:20.576Z
...
Added `is_buyer_request_cancel` parameter

 | 

Set this to `TRUE` to retrieve orders that have a buyer cancel request.
...
New property `is_buyer_request_cancel`

 | 

Returns `TRUE` if buyer has requested cancellation
...
New property `request_cancel_time`

 | 

The time when buyer requested cancellation
