...
|---|---|---|
| code | number | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202309GetPaymentsResponseData } from './GetPaymentsResponseData'; export class Finance202309GetPaymentsResponse { /** The success or failure status code returned in API response. |
...
## Finance202309GetPaymentsResponseData
| field | type | description |
|---|---|---|
| next_page_token | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202309GetPaymentsResponseDataPayments } from './GetPaymentsResponseDataPayments'; export class Finance202309GetPaymentsResponseData { /** An opaque token used to retrieve the next page of a paginated result set. Provide this value in the `page_token` parameter of your request if the current response does not return all the results. |
| payments | Array<Finance202309GetPaymentsResponseDataPayments> | The list of payments that meet the query conditions. |

## Finance202309GetPaymentsResponseDataPayments
| field | type | description |
|---|---|---|
| bank_account | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202309GetPaymentsResponseDataPaymentsAmount } from './GetPaymentsResponseDataPaymentsAmount'; import { Finance202309GetPaymentsResponseDataPaymentsPaymentAmountBeforeExchange } from './GetPaymentsResponseDataPaymentsPaymentAmountBeforeExchange'; import { Finance202309GetPaymentsResponseDataPaymentsReserveAmount } from './GetPaymentsResponseDataPaymentsReserveAmount'; import { Finance202309GetPaymentsResponseDataPaymentsSettlementAmount } from './GetPaymentsResponseDataPaymentsSettlementAmount'; export class Finance202309GetPaymentsResponseDataPayments { 'amount'?: Finance202309GetPaymentsResponseDataPaymentsAmount; /** The seller\'s bank account number masked, revealing only the last 4 digits for privacy. |
| create_time | number | The time when the payment was initiated in TikTok Shop. Unix timestamp. |
| exchange_rate | string | The exchange rate, displayed with six decimal places. |
| id | string | The payment ID. |
| paid_time | number | The time when the payment was successfully processed. Unix timestamp. |
...
| field | type | description |
|---|---|---|
| currency | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202309GetPaymentsResponseDataPaymentsAmount { /** The exchange currency code in ISO 4217 format. |
| value | string | The final payment amount. |

## Finance202309GetPaymentsResponseDataPaymentsPaymentAmountBeforeExchange
| field | type | description |
|---|---|---|
| currency | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202309GetPaymentsResponseDataPaymentsPaymentAmountBeforeExchange { /** The original currency code in ISO 4217 format. |
| value | string | The original payment amount. |

## Finance202309GetPaymentsResponseDataPaymentsReserveAmount
| field | type | description |
|---|---|---|
| currency | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202309GetPaymentsResponseDataPaymentsReserveAmount { /** The original currency code in ISO 4217 format. |
| value | string | The reserved amount. |

## Finance202309GetPaymentsResponseDataPaymentsSettlementAmount
| field | type | description |
|---|---|---|
| currency | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202309GetPaymentsResponseDataPaymentsSettlementAmount { /** The original currency code in ISO 4217 format. |
| value | string | The settlement amount. |

## Finance202309GetStatementsResponse
| field | type | description |
|---|---|---|
| code | number | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202309GetStatementsResponseData } from './GetStatementsResponseData'; export class Finance202309GetStatementsResponse { /** The success or failure status code returned in API response. |
| message | string | The success or failure messages returned in API response. Reasons of failure will be described in the message. |
| request_id | string | Request log. |
...
| field | type | description |
|---|---|---|
| next_page_token | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202309GetStatementsResponseDataStatements } from './GetStatementsResponseDataStatements'; export class Finance202309GetStatementsResponseData { /** An opaque token used to retrieve the next page of a paginated result set. Provide this value in the `page_token` parameter of your request if the current response does not return all the results. |
| statements | Array<Finance202309GetStatementsResponseDataStatements> | The list of statements that meet the query conditions. |

## Finance202309GetStatementsResponseDataStatements
| field | type | description |
|---|---|---|
| adjustment_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202309GetStatementsResponseDataStatements { /** The adjustment amount. For more details about the reason for adjustment, refer to the [Get Statement Transactions API](https://partner.tiktokshop.com/docv2/page/650a6749defece02be67da87). |
...
| payment_time | number | The Unix payment timestamp |
...
| statement_time | number | The time when the statement was generated. Unix timestamp.  Statements are generated daily at 00:00 UTC, and it includes all transactions from the past day. |

## Finance202309GetTransactionsbyOrderResponse
| field | type | description |
|---|---|---|
| code | number | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202309GetTransactionsbyOrderResponseData } from './GetTransactionsbyOrderResponseData'; export class Finance202309GetTransactionsbyOrderResponse { /** The success or failure status code returned in API response. |
| message | string | The success or failure messages returned in API response. Reasons of failure will be described in the message. |
| request_id | string | Request log. |
...
| field | type | description |
|---|---|---|
| order_create_time | number | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202309GetTransactionsbyOrderResponseDataStatementTransactions } from './GetTransactionsbyOrderResponseDataStatementTransactions'; export class Finance202309GetTransactionsbyOrderResponseData { /** The creation time of the order. Unix timestamp. |
| order_id | string | The order ID in TikTok Shop. |
| statement_transactions | Array<Finance202309GetTransactionsbyOrderResponseDataStatementTransactions> | The list of statement transactions associated with the order. |

## Finance202309GetTransactionsbyOrderResponseDataStatementTransactions
| field | type | description |
|---|---|---|
| actual_return_shipping_fee_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202309GetTransactionsbyOrderResponseDataStatementTransactionsSkuStatementTransactions } from './GetTransactionsbyOrderResponseDataStatementTransactionsSkuStatementTransactions'; export class Finance202309GetTransactionsbyOrderResponseDataStatementTransactions { /** The return shipping fee charged if the seller is responsible for the return. |
...
| sku_statement_transactions | Array<Finance202309GetTransactionsbyOrderResponseDataStatementTransactionsSkuStatementTransactions> | A list of SKU transactions included in the statement. Each item in this list corresponds to a single SKU. |
| statement_id | string | The statement ID. |
| statement_time | number | The creation time of the statement. Unix timestamp. |
...
| field | type | description |
|---|---|---|
| actual_return_shipping_fee_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202309GetTransactionsbyOrderResponseDataStatementTransactionsSkuStatementTransactions { /** The return shipping fee charged if the seller is responsible for the return. |
| actual_shipping_fee_amount | string | The actual shipping fee, calculated based on the weight/dimensions measured by the carrier. |
...
| promo_shipping_incentive_amount | string | The additional shipping incentive that the seller will receive if the seller signed up for the Co-Funded Free Shipping Program from 2024/08/26 to 2024/12/31. A negative amount indicates a reversal of incentives due to order refunds attributed to the seller\'s responsibility. |
| quantity | number | The SKU quantity. |
| referral_fee_amount | string | The referral fee charged for processing successful orders.  Applicable only for the US. |
| refund_administration_fee_amount | string | The 20% refund administration fee deducted from the total refunded referral fee amount. |
| refund_shipping_cost_discount_amount | string | The TikTok Shop shipping incentive to be reversed (and deducted) if the order was refunded as a result of the seller\'s responsibility. |
| retail_delivery_fee_amount | string | The final retail delivery fee for deliveries in Colorado, US. For more information, see [Colorado Retail Delivery Fee FAQ](https://seller-us.tiktok.com/university/essay?knowledge_id=2459780628350762&default_language=en&identity=1).  Formula: retail_delivery_fee_payment_amount + retail_delivery_fee_refund_amount. |
...
| field | type | description |
|---|---|---|
| code | number | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202309GetTransactionsbyStatementResponseData } from './GetTransactionsbyStatementResponseData'; export class Finance202309GetTransactionsbyStatementResponse { /** The success or failure status code returned in API response. |
| message | string | The success or failure messages returned in API response. Reasons of failure will be described in the message. |
| request_id | string | Request log. |
...
| field | type | description |
|---|---|---|
| adjustment_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202309GetTransactionsbyStatementResponseDataStatementTransactions } from './GetTransactionsbyStatementResponseDataStatementTransactions'; export class Finance202309GetTransactionsbyStatementResponseData { /** The total amount calculated by the platform when the order fees need to be changed, the specific adjustment type will be shown in fields type |
...
| statement_time | number | Time of statement in UTC time zone |
| statement_transactions | Array<Finance202309GetTransactionsbyStatementResponseDataStatementTransactions> | Statement list |
| total_count | number | The number of transaction records |

## Finance202309GetTransactionsbyStatementResponseDataStatementTransactions
| field | type | description |
|---|---|---|
| actual_return_shipping_fee_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202309GetTransactionsbyStatementResponseDataStatementTransactions { /** If the seller is responsible for the return, the return shipping fee will be charged. |
| actual_shipping_fee_amount | string | The actual shipping fee calculated based on the weight/dimensions measured by the carrier |
...
| iva_vat_amount | string | IVA refers to Mexican VAT that TikTok Shop is required to withhold on your taxable products and remit to the tax authority. |
| net_sales_amount | string | Used for US, UK L2L sellers only. The total revenue with any applicable seller discounts deducted.   net_sales_amount = gross_sales_amount + gross_sales_refund_amount + seller_discount_amount + seller_discount_refund_amount |
| order_create_time | number | The create time of the order |
...
| field | type | description |
|---|---|---|
| code | number | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202309GetWithdrawalsResponseData } from './GetWithdrawalsResponseData'; export class Finance202309GetWithdrawalsResponse { /** The success or failure status code returned in API response. |
| message | string | The success or failure messages returned in API response. Reasons of failure will be described in the message. |
| request_id | string | Request log. |
...
| field | type | description |
|---|---|---|
| next_page_token | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202309GetWithdrawalsResponseDataWithdrawals } from './GetWithdrawalsResponseDataWithdrawals'; export class Finance202309GetWithdrawalsResponseData { /** Cursor used for searching for more information |
| total_count | number | The total num of the withdraws |
| withdrawals | Array<Finance202309GetWithdrawalsResponseDataWithdrawals> | Withdraw list |

## Finance202309GetWithdrawalsResponseDataWithdrawals
| field | type | description |
|---|---|---|
| amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202309GetWithdrawalsResponseDataWithdrawals { /** Withdraw amount |
| create_time | number | Withdraw create time |
| currency | string | The three-digit currency code in ISO 4217 format. |
...
| field | type | description |
|---|---|---|
| code | number | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202501GetTransactionsbyOrderResponseData } from './GetTransactionsbyOrderResponseData'; export class Finance202501GetTransactionsbyOrderResponse { /** The success or failure status code returned in API response. |
| message | string | The success or failure messages returned in API response. Reasons of failure will be described in the message. |
| request_id | string | Request log. |
...
| field | type | description |
|---|---|---|
| currency | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202501GetTransactionsbyOrderResponseDataSkuTransactions } from './GetTransactionsbyOrderResponseDataSkuTransactions'; export class Finance202501GetTransactionsbyOrderResponseData { /** The three-digit currency code in ISO 4217 format. |
...
| order_create_time | number | The creation time of the order. Unix timestamp. |
| order_id | string | The order ID in TikTok Shop. |
...
| sku_transactions | Array<Finance202501GetTransactionsbyOrderResponseDataSkuTransactions> | The list of SKU transaction records for the order. |
| total_count | number | The number of transaction records |

## Finance202501GetTransactionsbyOrderResponseDataSkuTransactions
| field | type | description |
|---|---|---|
| fee_tax_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202501GetTransactionsbyOrderResponseDataSkuTransactionsFeeTaxBreakdown } from './GetTransactionsbyOrderResponseDataSkuTransactionsFeeTaxBreakdown'; import { Finance202501GetTransactionsbyOrderResponseDataSkuTransactionsRevenueBreakdown } from './GetTransactionsbyOrderResponseDataSkuTransactionsRevenueBreakdown'; import { Finance202501GetTransactionsbyOrderResponseDataSkuTransactionsShippingCostBreakdown } from './GetTransactionsbyOrderResponseDataSkuTransactionsShippingCostBreakdown'; export class Finance202501GetTransactionsbyOrderResponseDataSkuTransactions { /** The total fees and taxes charged by TikTok Shop at the time of order settlement. Shipping-related costs are excluded. This is equivalent to the sum of all contributory amounts in `fee_tax_breakdown`. |
...
| field | type | description |
|---|---|---|
| affiliate_ads_commission_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202501GetTransactionsbyOrderResponseDataSkuTransactionsFeeTaxBreakdownFee { /** The commission for eligible orders from ads. |
...
| campaign_period_fee_cfp_amount | string | Fee charged during Co-funded Promotion campaigns. |
| campaign_period_fee_cfp_tax_amount | string | Sales tax applied to the campaign period fee under Co-funded Promotion. |
| campaign_period_fee_sp_amount | string | Fee charged during Smart Promotion campaigns. |
| campaign_period_fee_sp_tax_amount | string | Sales tax applied to the campaign period fee under Smart Promotion. |
...
| gmv_max_ad_fee_amount | string | A percentage deducted from your net sales per order for GMV Max (net sales performance goal) advertising. |
...
| platform_semi_managed_commission_fee | string | Calculated as a percentage of (original price − seller discount + customer-paid shipping fee). |
| platform_semi_managed_commission_fee_tax | string | This amount is collected on behalf of the government. |
| platform_special_service_fee_amount | string | The portion of the Distance Shipping Fee paid by the customer that exceeds the logistics service provider\'s charge, retained by TikTok Shop to support a secure fulfillment experience |
| pre_order_service_fee_amount | string | The service fee charged when seller joins Pre-order program. |
| referral_fee_amount | string | The referral fee charged for processing successful orders. Applicable only for the US. |
| refund_administration_fee_amount | string | The 20% refund administration fee deducted from the total refunded referral fee amount. |
| seller_growth_fee_amount | string | A fee charged on each successful order to provide Bonus Cashback and other growth benefits. |
...
| smart_promotion_fee_amount | string | This fee includes funds from TikTok Shop to help provide promotions to customers |
...
| field | type | description |
|---|---|---|
| anti_dumping_duty_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202501GetTransactionsbyOrderResponseDataSkuTransactionsFeeTaxBreakdownTax { /** The anti-dumping duties collected by governments for import goods. |
| cedular_tax | string | The Mexican Guanajuato cedular tax |
...
| sales_tax_referral_fee_amount | string | Some U.S. states consider referral fees taxable. To comply with state tax laws, TikTok Inc. collects and remits applicable sales tax when a taxable fee is charged. |
| smart_promotion_fee_tax_amount | string | Sales tax for the Smart Promotion fee |
...
| field | type | description |
|---|---|---|
| cod_service_fee_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202501GetTransactionsbyOrderResponseDataSkuTransactionsRevenueBreakdown { /** The cash on delivery service fees charged to buyers. Applicable only for Saudi Arabia. |
| distant_item_fee_amount | string | The distance fee for items paid by the customer. With your current settings for Horizon+ Program, this fee is included in product price for orders with shipping out of Java island. |
...
| field | type | description |
|---|---|---|
| actual_shipping_fee_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202501GetTransactionsbyOrderResponseDataSkuTransactionsShippingCostBreakdownSupplementaryComponent } from './GetTransactionsbyOrderResponseDataSkuTransactionsShippingCostBreakdownSupplementaryComponent'; export class Finance202501GetTransactionsbyOrderResponseDataSkuTransactionsShippingCostBreakdown { /** The actual shipping fee calculated based on the weight/dimensions measured by the carrier. For details, check `shipping_cost_breakdown.supplementary_component`. |
...
| distant_shipping_fee_amount | string | The distance fee for shipping paid by the customer. With your current settings for Horizon+ Program, this fee is included in product price for orders with shipping out of Java island. |
...
| fbt_fulfillment_fee_reimbursement_amount | string | A reimbursement from TikTok Shop for Fulfilled by TikTok (FBT) orders that don\'t qualify for free shipping. Applicable only for the US. |
| fbt_key_merchant_subsidy | string | Subsidy applied to your orders based on eligibility for the key merchant program. The amount is calculated based on your qualifying FBT (Fulfilled by TikTok) order volume during the statement period. |
| fbt_overall_merchant_subsidy | string | Subsidy applied to your orders and offered to all FBT (Fulfilled by TikTok) merchants for the statement period. The amount is calculated based on your qualifying FBT order volume during this period. |
...
| logistics_service_fee | string | A fee charged to sellers throughout the order lifecycle for logistics-related services, including processing, coordination, handling of delivery-related matters, and basic shipping incentives. It is an amount per order, which is based on the parcel\'s weight tier and shipping route. It allows the platform to continuously enhance a high-quality, sustainable logistics network that serves both sellers and customers better over the long term, amidst changing global conditions. |
...
| shipping_app_service_fee_amount | string | Shipping App Service Fee for using shipping fee to generate shipping labels |
...
| field | type | description |
|---|---|---|
| code | number | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202501GetTransactionsbyStatementResponseData } from './GetTransactionsbyStatementResponseData'; export class Finance202501GetTransactionsbyStatementResponse { /** The success or failure status code returned in API response. |
| message | string | The success or failure messages returned in API response. Reasons of failure will be described in the message. |
| request_id | string | Request log. |
...
| field | type | description |
|---|---|---|
| create_time | number | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202501GetTransactionsbyStatementResponseDataTotalSettlementBreakdown } from './GetTransactionsbyStatementResponseDataTotalSettlementBreakdown'; import { Finance202501GetTransactionsbyStatementResponseDataTransactions } from './GetTransactionsbyStatementResponseDataTransactions'; export class Finance202501GetTransactionsbyStatementResponseData { /** The time when the statement was generated. Unix timestamp.  Statements are generated daily at 00:00 UTC. |
| currency | string | The three-digit currency code in ISO 4217 format. |
| id | string | The statement ID. |
...
| total_count | number | The number of transaction records in the statement. |
...
| transactions | Array<Finance202501GetTransactionsbyStatementResponseDataTransactions> | The list of transaction records in the statement. Each transaction corresponds to an order, an adjustment, or a reserve-related transaction. |

## Finance202501GetTransactionsbyStatementResponseDataTotalSettlementBreakdown
| field | type | description |
|---|---|---|
| total_adjustment_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202501GetTransactionsbyStatementResponseDataTotalSettlementBreakdown { /** The total adjustment amount based on TikTok Shop policy.  Refer to `transactions.type` for the list of adjustment-related policies. |
...
| field | type | description |
|---|---|---|
| adjustment_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202501GetTransactionsbyStatementResponseDataTransactionsFeeTaxBreakdown } from './GetTransactionsbyStatementResponseDataTransactionsFeeTaxBreakdown'; import { Finance202501GetTransactionsbyStatementResponseDataTransactionsRevenueBreakdown } from './GetTransactionsbyStatementResponseDataTransactionsRevenueBreakdown'; import { Finance202501GetTransactionsbyStatementResponseDataTransactionsShippingCostBreakdown } from './GetTransactionsbyStatementResponseDataTransactionsShippingCostBreakdown'; import { Finance202501GetTransactionsbyStatementResponseDataTransactionsSupplementaryComponent } from './GetTransactionsbyStatementResponseDataTransactionsSupplementaryComponent'; export class Finance202501GetTransactionsbyStatementResponseDataTransactions { /** The adjustment amount based on TikTok Shop policy.  Refer to `transactions.type` for the list of adjustment-related policies. |
...
| field | type | description |
|---|---|---|
| affiliate_ads_commission_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202501GetTransactionsbyStatementResponseDataTransactionsFeeTaxBreakdownFee { /** The commission for eligible orders from ads. |
| affiliate_commission_amount | string | The commission amount charged to the seller for payment to the creator. |
| affiliate_commission_amount_before_pit | string | The affiliate ads commission paid to a creator before any personal income tax withholding.  Applicable only for SEA markets. |
| affiliate_commission_deposit | string | The amount reserved for creator commissions after an order is paid. Applies only to commissions tied to order volume and is based on the highest earning rate. |
| affiliate_commission_release | string | The commission deposit refunded to you after order settlement. Applies only to commissions tied to order volume. |
...
| field | type | description |
|---|---|---|
| anti_dumping_duty_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202501GetTransactionsbyStatementResponseDataTransactionsFeeTaxBreakdownTax { /** The anti-dumping duties collected by governments for import goods. |
| cedular_tax | string | The Mexican Guanajuato cedular tax |
| customs_clearance_amount | string | The fees charged by logistic suppliers for customs clearance services.   Applicable only for cross-border shop orders. |
| customs_duty_amount | string | The customs duties, a type of tax on cross-border goods collected by governments.   Applicable only for cross-border shop orders. |
| gst_amount | string | The goods and services tax (GST) collected and remitted to the tax authority by the platform for low-value goods imported into Singapore, effective January 1, 2023. |
...
| field | type | description |
|---|---|---|
| cod_service_fee_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202501GetTransactionsbyStatementResponseDataTransactionsRevenueBreakdown { /** The cash on delivery service fees charged to buyers. Applicable only for Saudi Arabia. |
| distant_item_fee_amount | string | The distance fee for items paid by the customer. With your current settings for Horizon+ Program, this fee is included in product price for orders with shipping out of Java island. |
| refund_cod_service_fee_amount | string | The refund for cash on delivery service fees. Applicable only for Saudi Arabia. |
| refund_subtotal_before_discount_amount | string | The total price of all refunded items before any seller discounts. This is equivalent to the shop\'s gross sales refund. |
| seller_discount_amount | string | The total amount of discounts funded by the seller, including: - Seller promotions (Product Discount, Flash Deal, Buy More Save More, Voucher and Bundle Deal) - Seller\'s portion of a co-funded voucher discount in co-funding campaigns - Seller discounts during a campaign |
...
| field | type | description |
|---|---|---|
| actual_shipping_fee_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202501GetTransactionsbyStatementResponseDataTransactionsShippingCostBreakdownSupplementaryComponent } from './GetTransactionsbyStatementResponseDataTransactionsShippingCostBreakdownSupplementaryComponent'; export class Finance202501GetTransactionsbyStatementResponseDataTransactionsShippingCostBreakdown { /** The actual shipping fee calculated based on the weight/dimensions measured by the carrier. For details, check `shipping_cost_breakdown.supplementary_component`. |
| customer_paid_shipping_fee_amount | string | The actual shipping fee borne by the customer, calculated based on the product weight uploaded by the seller. Negative numbers refer to the refunded amount of customer-paid shipping fees |
| distant_shipping_fee_amount | string | The distance fee for shipping paid by the customer. With your current settings for Horizon+ Program, this fee is included in product price for orders with shipping out of Java island. |
| exchange_shipping_fee_amount | string | The shipping fee paid by the seller for the delivery of goods exchange.  Applicable only for Indonesia. |
| failed_delivery_subsidy_amount | string | For shipping fee from failed deliveries, you pay up to a standard rate, and TikTok Shop covers the remaining amount. |
...
| field | type | description |
|---|---|---|
| customer_shipping_fee | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202501GetTransactionsbyStatementResponseDataTransactionsShippingCostBreakdownSupplementaryComponent { /** The shipping fee borne by the customer.This is part of `customer_paid_shipping_fee_amount`. |
| customer_shipping_fee_offset_amount | string | The fee to offset TikTok Shop Shipping Incentive or customer-paid shipping fee, resulting in a net charge of $0 to the seller.  Applicable only for the US. |
| fbm_shipping_cost_amount | string | The shipping fee incurred by the seller for using TikTok Shipping. This is part of `actual_shipping_fee_amount`. |
| fbt_fulfillment_fee_amount | string | The shipping and warehouse fulfillment fee incurred by the seller for orders fulfilled by TikTok (FBT). This is part of `actual_shipping_fee_amount`.  Applicable only for the US. |
| fbt_fulfillment_fee_reimbursement_amount | string | (**Deprecated**: This field is deprecated and will return an empty string. Please refer to `shipping_cost_breakdown.fbt_fulfillment_fee_reimbursement_amount` instead for the relevant details.) |
...
| field | type | description |
|---|---|---|
| customer_payment_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202501GetTransactionsbyStatementResponseDataTransactionsSupplementaryComponent { /** The total amount paid by the customer. |
| customer_refund_amount | string | The exact amount refunded to the customer. |
...
| field | type | description |
|---|---|---|
| code | number | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202507GetUnsettledTransactionsResponseData } from './GetUnsettledTransactionsResponseData'; export class Finance202507GetUnsettledTransactionsResponse { /** The success or failure status code returned in API response. |
| message | string | The success or failure messages returned in API response. Reasons of failure will be described in the message. |
| request_id | string | Request log. |
...
| field | type | description |
|---|---|---|
| next_page_token | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202507GetUnsettledTransactionsResponseDataTransactions } from './GetUnsettledTransactionsResponseDataTransactions'; export class Finance202507GetUnsettledTransactionsResponseData { /** An opaque token used to retrieve the next page of a paginated result set. Provide this value in the `page_token` parameter of your request if the current response does not return all the results. |
...
| total_count | number | The number of transaction records in the statement. |
| transactions | Array<Finance202507GetUnsettledTransactionsResponseDataTransactions> | The list of transaction records in the statement. Each transaction corresponds to an order, an adjustment, or a reserve-related transaction. |

## Finance202507GetUnsettledTransactionsResponseDataTransactions
| field | type | description |
|---|---|---|
| adjustment_id | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202507GetUnsettledTransactionsResponseDataTransactionsFeeTaxBreakdown } from './GetUnsettledTransactionsResponseDataTransactionsFeeTaxBreakdown'; import { Finance202507GetUnsettledTransactionsResponseDataTransactionsRevenueBreakdown } from './GetUnsettledTransactionsResponseDataTransactionsRevenueBreakdown'; import { Finance202507GetUnsettledTransactionsResponseDataTransactionsShippingCostBreakdown } from './GetUnsettledTransactionsResponseDataTransactionsShippingCostBreakdown'; export class Finance202507GetUnsettledTransactionsResponseDataTransactions { /** The adjustment ID if the transaction is an adjustment. Each transaction can only be associated with an order ID or an adjustment ID. |
| adjustment_order_id | string | The order ID associated with the adjustment, if any. |
| currency | string | The three-digit currency code in ISO 4217 format. |
...
| id | string | The transaction ID. |
| order_create_time | number | The creation time of the order. Unix timestamp. |
| order_delivery_time | number | The delivery time of the order. Unix timestamp. if order hasn\'t been delivered, no data will be return |
| order_id | string | The order ID. Each transaction can only be associated with an order ID or an adjustment ID. |
...
| field | type | description |
|---|---|---|
| affiliate_ads_commission_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202507GetUnsettledTransactionsResponseDataTransactionsFeeTaxBreakdownFee { /** The commission for eligible orders from ads. |
| affiliate_commission_amount | string | The commission amount charged to the seller for payment to the creator. |
...
| field | type | description |
|---|---|---|
| cedular_tax | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202507GetUnsettledTransactionsResponseDataTransactionsFeeTaxBreakdownTax { /** The Mexican Guanajuato cedular tax |
| customs_clearance_amount | string | The fees charged by logistic suppliers for customs clearance services.  Applicable only for cross-border shop orders. |
| customs_duty_amount | string | The customs duties, a type of tax on cross-border goods collected by governments.  Applicable only for cross-border shop orders. |
| gst_amount | string | The goods and services tax (GST) collected and remitted to the tax authority by the platform for low-value goods imported into Singapore, effective January 1, 2023. |
...
| sales_tax_referral_fee_amount | string | Some U.S. states consider referral fees taxable. To comply with state tax laws, TikTok Inc. collects and remits applicable sales tax when a taxable fee is charged. |
| sales_tax_refund_amount | string | The sales tax amount returned to the customer in the event of a refund. |
| smart_promotion_fee_tax_amount | string | smart_promotion_fee_tax_amount |
| sst_amount | string | The sales and service tax (SST) collected and remitted to the tax authority by the platform for low-value goods imported into Malaysia, effective January 1, 2024. |
| vat_amount | string | The VAT paid by the platform on the seller\'s behalf.  Applicable only for cross-border shop orders. |
...
| field | type | description |
|---|---|---|
| cod_service_fee_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202507GetUnsettledTransactionsResponseDataTransactionsRevenueBreakdown { /** The cash on delivery service fees charged to buyers. Applicable only for Saudi Arabia. |
| distant_item_fee_amount | string | The distance fee for items paid by the customer. With your current settings for Horizon+ Program, this fee is included in product price for orders with shipping out of Java island. |
| refund_cod_service_fee_amount | string | The refund for cash on delivery service fees. Applicable only for Saudi Arabia. |
| refund_subtotal_before_discount_amount | string | The total price of all refunded items before any seller discounts. This is equivalent to the shop\'s gross sales refund. |
| seller_discount_amount | string | The total amount of discounts funded by the seller, including: - Seller promotions (Product Discount, Flash Deal, Buy More Save More, Voucher and Bundle Deal) - Seller\'s portion of a co-funded voucher discount in co-funding campaigns - Seller discounts during a campaign |
...
| field | type | description |
|---|---|---|
| actual_shipping_fee_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; import { Finance202507GetUnsettledTransactionsResponseDataTransactionsShippingCostBreakdownSupplementaryComponent } from './GetUnsettledTransactionsResponseDataTransactionsShippingCostBreakdownSupplementaryComponent'; export class Finance202507GetUnsettledTransactionsResponseDataTransactionsShippingCostBreakdown { /** The actual shipping fee calculated based on the weight/dimensions measured by the carrier. For details, check ` shipping_cost_breakdown.supplementary_component`. |
| customer_paid_shipping_fee_amount | string | The actual shipping fee borne by the customer, calculated based on the product weight uploaded by the seller. |
| distant_shipping_fee_amount | string | The distance fee for shipping paid by the customer. With your current settings for Horizon+ Program, this fee is included in product price for orders with shipping out of Java island. |
| exchange_shipping_fee_amount | string | The shipping fee paid by the seller for the delivery of goods exchange. Applicable only for Indonesia. |
| fbt_key_merchant_subsidy | string | Subsidy applied to your orders based on eligibility for the key merchant program. The amount is calculated based on your qualifying FBT (Fulfilled by TikTok) order volume during the statement period. |
...
| field | type | description |
|---|---|---|
| customer_shipping_fee_offset_amount | string | tiktok shop openapi sdk for apis The version of the OpenAPI document: 1.0.0 NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech). https://openapi-generator.tech Do not edit the class manually. / import { RequestFile } from '../../models'; export class Finance202507GetUnsettledTransactionsResponseDataTransactionsShippingCostBreakdownSupplementaryComponent { /** The fee to offset TikTok Shop Shipping Incentive or customer-paid shipping fee, resulting in a net charge of $0 to the seller. Applicable only for the US. |
| fbm_shipping_cost_amount | string | The shipping fee incurred by the seller for using TikTok Shipping. This is part of `actual_shipping_fee_amount`. |
| fbt_fulfillment_fee_amount | string | The shipping and warehouse fulfillment fee incurred by the seller for orders fulfilled by TikTok (FBT). This is part of `actual_shipping_fee_amount`. Applicable only for the US. |
