...
> API path: /size/chart/template/get
> Category: Product API
> Scraped: 2026-05-20T23:09:47.702Z
...
| Name | Type | Required or not | Description |
| --- | --- | --- | --- |
| template\_id | Number | No | size chart template id |
| template\_name | String | No | size chart name |
