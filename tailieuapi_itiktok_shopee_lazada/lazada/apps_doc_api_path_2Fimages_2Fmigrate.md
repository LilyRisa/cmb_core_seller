...
> API path: /images/migrate
> Category: Product API
> Scraped: 2026-05-20T23:10:39.123Z
...
| --- | --- | --- |
| batch\_id | String | The returned request ID is used by the GetResponse API to get the migrated image information. |
## Error Code
