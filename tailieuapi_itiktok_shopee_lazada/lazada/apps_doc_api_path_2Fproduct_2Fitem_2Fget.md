...
> API path: /product/item/get
> Category: Product API
> Scraped: 2026-05-20T23:08:55.962Z
...
| seller\_sku | String | No | The parameter has been deprecated and is no longer supported after November 15th, 2023. |
## Response Parameters
...
| bizSupplement | Object | global feature field |
| imageSequence | Object | ai image sequence |
## Error Code
...
| 207 | SKU not exist | The item id used in the request does not exist on the current site.Please call GetProducts API to check if the sku you are querying belongs to the current store or if the item id is correct. |
| 207 | SKU not exist | The item id used in the request does not exist on the current site.Please call GetProducts API to check if the sku you are querying belongs to the current store or if the item id is correct. |
| EDIT\_ITEM\_NOT\_BELONG\_SELLER | You are not authorized to edit the item. | The item id queried in the request does not belong to the current store, please call the GetProducts API to resynchronize the product list to ensure the accuracy of the item id. |
| EDIT\_ITEM\_NOT\_BELONG\_SELLER | You are not authorized to edit the item. | The item id queried in the request does not belong to the current store, please call the GetProducts API to resynchronize the product list to ensure the accuracy of the item id. |
| 901 | Limit service request speed in server side temporarily. | API level QPS limiting flow, please retry in the next second when you encounter this error. |
