...
> API path: /product/seller/item/getPreQcRules
> Category: Product API
> Scraped: 2026-05-20T23:08:29.924Z
...
| option\_set | Number\[\] | Yes | query qc rules option.\[1\] return item limit, \[2\] return restricted category id, \[1,2\] return both |
## Response Parameters

| Name | Type | Description |
| --- | --- | --- |
| values | Object | response value |
| restricted\_cate\_ids | Number\[\] | restricted category id which can not publish |
| item\_limit | Number | item quantity limit |
| item\_count | Number | current item count |
## Error Code
