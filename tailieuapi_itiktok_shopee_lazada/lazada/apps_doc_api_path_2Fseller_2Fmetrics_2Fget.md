...
> API path: /seller/metrics/get
> Category: Seller API
> Scraped: 2026-05-20T23:03:14.188Z
...
| main\_category\_name | String | main\_category\_name |
| seller\_id | Number | seller\_id |
| response\_rate | String | response\_rate |
| response\_time | String | response\_time |
| ship\_on\_time | String | ship\_on\_time |
| main\_category\_id | Number | main\_category\_id |
| positive\_seller\_rating | String | positive\_seller\_rating |
## Error Code
