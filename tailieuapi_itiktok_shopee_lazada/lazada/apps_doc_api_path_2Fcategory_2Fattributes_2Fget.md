...
> API path: /category/attributes/get
> Category: Product API
> Scraped: 2026-05-20T23:07:37.812Z
...
| Name | Type | Required or not | Description |
| --- | --- | --- | --- |
| primary\_category\_id | String | Yes | identifiers of category code |
...
| en\_name | String | Option name in English |
| id | Number | options id |
| is\_sale\_prop | Number | Whether the attribute is sale property |
| id | Number | attribute id |
| unit | Object | { "precision": 1, "type": \[ "inch", "cm" \], "numericMin": "1", "numericMax": "999" } |
| type | String\[\] | \[ "inch", "cm" \] |
| numericMin | String | 1 |
| numericMax | String | 999 |
| precision | Number | 0 |
## Error Code
