# POSTEarlyBirdActivityDeactivateSkus

> Source: https://open.lazada.com/apps/doc/api?path=%2Factivity%2Fearly%2Fbird%2FdeactivateSkus
> API path: /activity/early/bird/deactivateSkus
> Category: Early Bird Price API
> Scraped: 2026-05-20T23:22:18.681Z

---

Latest update2026-02-27 15:29:39
...
| order\_total\_budget | Number | No | order total budget inventory |
| discount\_price | Object | No | discount price |
...
| --- | --- | --- |
| No Data |
[API Testing Tool](//isvconsole.lazada.com/apps/console/test_api#/activity/early/bird/deactivateSkus)[SDK Download](//isvconsole.lazada.com/apps/console/sdk_download)
...
request.setApiName("/activity/early/bird/deactivateSkus");
request.addApiParameter("sku_list", "[{\"discount_price\":{},\"product_id\":\"123\",\"sku_id\":\"456\",\"order_total_budget\":\"5\"}]");
