# GETGetWarehouseStock

> Source: https://open.lazada.com/apps/doc/api?path=%2Ffbl%2Fstocks%2Fget
> API path: /fbl/stocks/get
> Category: FBL API
> Scraped: 2026-05-20T23:42:00.956Z

---

Latest update2022-07-29 18:28:46
...
| fulfilment\_sku | String | No | List of shop SKU, Comma separated list in square brackets |
...
| available | Number | Sellable available Stock |
| reserved | Number | Sellable reserved Stocks |
| unsellable | Object | Unsellable Stock |
| available | Number | Unsellable available Stock |
| reserved | Number | Unsellable reserved Stocks |
| pending | Object | Pending Stock |
| reserved | Number | Pending reserved Stocks |
| available | Number | Pending available Stock |
## Error Code

| Error Code | Error Message | Solution |
| --- | --- | --- |
| No Data |
[API Testing Tool](//isvconsole.lazada.com/apps/console/test_api#/fbl/stocks/get)[SDK Download](//isvconsole.lazada.com/apps/console/sdk_download)
