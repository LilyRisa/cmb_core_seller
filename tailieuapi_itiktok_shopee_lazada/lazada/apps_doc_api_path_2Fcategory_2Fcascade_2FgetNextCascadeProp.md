...
> API path: /category/cascade/getNextCascadeProp
> Category: Product API
> Scraped: 2026-05-20T23:08:15.639Z
...
| prop | Object | cascade property |
| id | Number | property id |
| name | String | property name |
| required | Boolean | Whether the attribute is mandatory |
| propValue | Object\[\] | cascade property value |
| id | Number | property value id |
| name | String | property value name |
| leaf | String | whether is leaf node |
## Error Code
