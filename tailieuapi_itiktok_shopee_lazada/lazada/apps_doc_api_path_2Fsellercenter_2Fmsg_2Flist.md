...
> API path: /sellercenter/msg/list
> Category: Seller API
> Scraped: 2026-05-20T23:04:08.821Z
...
| message\_content | Object | message content |
| title | String | title |
| description | String | description |
| categoryName | String | msg category name |
| picture | String | msg img url |
| webLink | String | web jump link |
| appLink | String | app jump link |
