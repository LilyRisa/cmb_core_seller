...
> API path: /product/qc/alert/list
> Category: Product API
> Scraped: 2026-05-20T23:09:19.028Z
...
| deactivationTime | Number | Date to execute deactivation |
| suggestionCategories | Number\[\] | suggested categories |
## Error Code
