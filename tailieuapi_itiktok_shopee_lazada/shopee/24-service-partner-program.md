...
> Source: https://open.shopee.com/developer-guide/24
> Category: 
> Scraped: 2026-05-20T20:37:12.296Z
...
<table><tbody><tr><td colspan="" rowspan=""><span><span>⚠️ Note</span></span><ul><li><span>ISVs which are not qualified to become a Premium Service Partner for the quarter </span><span>will not receive a quarterly performance report</span><span>.</span></li><li><span>ISVs are assessed based on performance </span><span>in each individual market</span><span>, and not on an aggregated basis. Rewards will also be provided only in the markets that have met our criteria.</span></li></ul></td></tr></tbody></table>
...
<table><tbody><tr><td colspan="" rowspan=""><span><span>⚠️ Note</span></span><ul><li><span>[Important] </span><span>Shopee reserves the right to exclude certain ISVs from our Service Partner Program </span><span>if they are found to be violating our </span><a href="https://open.shopee.com/developer-guide/34">Platform Partner Rules</a><span>, such as by engaging in crawling activities.&nbsp; This is even if they have met the criteria above.</span></li><li><span>Criteria above are also subject to changes as and when Shopee deems it to be necessary.</span></li></ul></td></tr></tbody></table>
...
You can find out about market-specific marketing benefits by reaching out to your Relationship Managers (RMs). You may also raise a ticket via our [Shopee Ticket System](https://open.shopee.com/myconsole/ticket-system/raise-ticket).
...
You may reach out to your Relationship Manager (RM) or your local Product Support team if you have any questions. You will be able to find this detail in the email sent to you if you are eligible for the program. You may also raise a ticket via our [Shopee Ticket System](https://open.shopee.com/myconsole/ticket-system/raise-ticket).
