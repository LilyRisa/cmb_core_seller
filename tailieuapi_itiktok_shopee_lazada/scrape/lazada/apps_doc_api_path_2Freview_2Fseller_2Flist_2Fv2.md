...
> Scraped: 2026-05-20T22:57:34.273Z
...
the time when buyer submited this review
...
if review can be replied by seller
...
review ratings(only PRODUCT\_REVIEW has ratings, FOLLOW\_UP\_REVIEWS doesn't have)
...
PRODUCT\_REVIEW or FOLLOW\_UP\_REVIEW.
...
the time when review data created, this is the same with "start\_time" and "end\_time" in the request data of interface(/review/seller/history/list)
...
id list if review is not exist or won't show(outdated/rejected) any more
