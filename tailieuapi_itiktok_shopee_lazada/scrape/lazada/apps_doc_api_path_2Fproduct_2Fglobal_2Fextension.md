...
> Scraped: 2026-05-20T22:53:50.542Z
...
Batch size is limited to 50, if global\_Item\_ids is present, this field will be ignored
...
country,if global\_Item\_ids is present, this field will be ignored
...
process result，If this is true, it doesn't mean that everything is processed successfully. It is necessary to judge that the item\_err\_code in packages is equal to 0 to determine that the processing is successful.
...
average number of items included in an order
