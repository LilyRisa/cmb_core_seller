...
> Scraped: 2026-05-20T22:50:23.154Z
...
The number of total Items, it's item level.
...
An array contains at least one Product.
...
Contains several product attributes.
...
An array contains at least one SKU.
...
Whether product is trial product
...
The value for the offset parameter is not valid.
...
The value for the limit parameter is not valid.
...
The specified status filter is not valid.
...
Data in the SKU list are not valid.
...
E506: Get product failed

 | 

Failed to get the product information.
...
Seller not verified,please check seller status

 | 

The seller's store opening process has not been completed, please log in to the Seller Center, check the store information that needs to be improved on the home page and submit it for review.
...
The limit field value is incorrect and should not exceed a maximum of 50.
