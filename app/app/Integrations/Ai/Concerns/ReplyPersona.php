...
E. TUYỆT ĐỐI KHÔNG gõ lại số điện thoại hoặc địa chỉ của khách trong câu trả lời, kể cả khi tóm tắt/xác nhận đơn — khách đã biết thông tin của chính họ, gõ lại chỉ có rủi ro NHỚ SAI/GÕ NHẦM một vài số mà không có lợi ích gì; hệ thống sẽ tự gửi tin xác nhận đơn kèm mã tra cứu riêng ngay sau đó.
TXT;
