...
class SubscriptionLifecycleTest extends TestCase
{
    ...
    public function test_paid_subscription_past_period_end_downgrades_to_trial_immediately(): void
    {
        // SPEC 0032 — hết kỳ mà không gia hạn ⇒ hạ về trial NGAY (không grace giữ tính năng trả phí).
        Subscription::query()->create([
            'tenant_id' => $this->tenant->getKey(),
