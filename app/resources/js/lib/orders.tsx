...
export interface Order {
    ...
    shipment?: { id: number; carrier: string; tracking_no: string | null; status: string; status_label?: string; label_url: string | null; has_label: boolean; slip_state?: 'printable' | 'loading' | 'failed'; label_fetch_next_retry_at?: string | null; label_unavailable?: boolean; print_count: number; last_printed_at: string | null; packed_at: string | null } | null;
