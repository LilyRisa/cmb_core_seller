...
export function OrderDetailBody({ order }: { order: Order }) {
    ...
    return (
        <>
            ...
            {order.has_unmapped_sku && <Alert type="warning" showIcon icon={<LinkOutlined />} style={{ marginBottom: 16 }} message="Đơn này chưa liên kết SKU" description="Vẫn in phiếu & bàn giao bình thường — KHÔNG trừ tồn cho các dòng chưa ghép. Liên kết SKU sàn ↔ master SKU để theo dõi tồn kho chính xác."
