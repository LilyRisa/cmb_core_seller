...
- ☐ **Chưa làm (đẩy sang Phase sau / backlog):** sửa line-item của đơn manual sau khi tạo (hiện huỷ + tạo lại) · cảnh báo realtime hết hàng/âm kho (Phase 6 — Notifications; hiện chỉ flag UI) · FE đầy đủ cho Sản phẩm/Tồn kho/Liên kết SKU/Tạo đơn (đã có bản tối thiểu) + Vitest. WMS đầy đủ — nhập/xuất/điều chuyển/kiểm kê/giá vốn FIFO — Phase 5.
