...
- Sản phẩm không có SKU biến thể (1 SKU duy nhất) → vẫn dùng chung cơ chế mở rộng dòng (đơn giản/nhất quán hơn là tách 2 đường sửa-tại-chỗ khác nhau) — chỉ 1 cú bấm thêm để mở, không mất chức năng.
