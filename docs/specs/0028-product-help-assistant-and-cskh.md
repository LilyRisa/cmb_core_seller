...
- **Cập nhật 2026-05-31 — UX chat CSKH + âm thanh + api_key hiển thị:**
  ...
  - Realtime: `useSupportRequests` polling 8s khi tab mở; khi xuất hiện câu trả lời MỚI từ CSKH
    → phát âm thanh `public/quick-ting.mp3` (baseline lần đầu không kêu cho lịch sử cũ).
